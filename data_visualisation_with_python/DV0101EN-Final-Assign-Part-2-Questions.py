...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={
        'textAlign': 'center', 'color': "#503d36", 'font-size': '24px'
    ...
    html.Div([  # TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={
                'width': '80%', 'padding': '3px', 'font-size': '20px', 
    ...
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(
                ...
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Automobiles Sold by Vehicle Type over Recession Period"
            )
        )
        ...
        unemprate_sales = recession_data.groupby(['unemployment_rate', 'Vehicle_Type'])['Automobile_Sales'].sum().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemprate_sales,
                x='unemployment_rate',
